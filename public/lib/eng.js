...
Eng.Matrix.lookAt = function (pointAtMatrix) {
  ...
  pointInverse.m[3][0] = -(pointAtMatrix[3][0] * pointInverse.m[0][0] + pointAtMatrix[3][1] * pointInverse.m[1][0] + pointAtMatrix[3][2] * pointInverse.m[2][0]);
  pointInverse.m[3][1] = -(pointAtMatrix[3][0] * pointInverse.m[0][1] + pointAtMatrix[3][1] * pointInverse.m[1][1] + pointAtMatrix[3][2] * pointInverse.m[2][1]);
  pointInverse.m[3][2] = -(pointAtMatrix[3][0] * pointInverse.m[0][2] + pointAtMatrix[3][1] * pointInverse.m[1][2] + pointAtMatrix[3][2] * pointInverse.m[2][2]);
...
Eng.Renderer = class {
  ...
  render(scene, cam) {
    ...
    for (let pol of polygons) {
      ...
      flatPolygon.color = `hsl(0, 0%, ${-polLight * 100}%)`;
    ...
    this.ctx.fillText("3D ENG", 100, 50);
  }
};
